...
\begin{center}
\textbf{La Mecanica detras del OLS}
...
{\Large \textbf{Volvamos a repensar la formula del modelo de regresion, pero en terminos de matrices:}}



Definamos lo que conocemos:
...
...y veamos c\'omo se ve OLS pero con matrices:
...
Aqui $\displaystyle \epsilon _{\text{Pedro}}$=0. En ese sentido, $\displaystyle e_{i}$ es la diferencia entre lo que estimamos y lo que observamos. "Filosoficamente", significa otra cosa.
...
{\Large \textbf{Formula para sacar }$\displaystyle \beta $\textbf{ (el efecto de }$\displaystyle X$\textbf{ sobre }$\displaystyle Y$\textbf{):}}
...
Recapitulemos lo observado, y hagamos el c\'alculo:
